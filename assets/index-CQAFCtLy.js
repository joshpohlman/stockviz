      ...
      <div class="fund-body">
        ${it.map(t=>`
          <section class="fund-section ${ei===t.id?`active`:``}" data-section="${t.id}">
            ...
            <div class="fund-grid">
              ${t.fields.map(t=>{let i=ot(t,e,n,r),a=at(i,t.fmt,e,r),o=t.fmt===`pct`&&i!=null?G(i):``;return`
                  <div class="fund-row">
  ...
  `}var K=`overview`,q,J,oi,si;function ci(){q=document.getElementById(`quote-panel`),J=document.getElementById(`quote-panel-body`),oi=document.getElementById(`quote-overlay`),si=document.getElementById(`quote-close`),si?.addEventListener(`click`,ui),oi?.addEventListener(`click`,ui),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&q&&!q.hidden&&ui()})}function li(e){q&&(q.hidden=!1,oi.hidden=!1,q.classList.add(`open`),J.innerHTML=`<div class="quote-loading"><div class="skeleton-line"></div><div class="skeleton-line short"></div></div>`,di(e))}function ui(){q&&(q.classList.remove(`open`),setTimeout(()=>{q.hidden=!0,oi.hidden=!0},200),An(null))}async function di(e){let t=z(),n=B().get(e),[r,i,a,o,s,c]=await Promise.all([n?.fundamentals?.peg==null?Vt(e,t):Promise.resolve(n),Wt(e,t),Ht(e,t),Hr(e,t),Ur(e,t),Wr(e,t)]),l=r;if(l&&a&&!n?.fundamentals?.peg){let e=A(t)===`fmp`?{fmpMetrics:a}:{finnhubMetrics:a};l=k(l,e)}let u=l?.candles||await Ut(e,t);if(!l){J.innerHTML=`<p class="quote-error">Could not load quote.</p>`;return}let d=G(l.changePct),f=Nn(e),p=Vn().includes(e),m=l.fundamentals||{};J.innerHTML=`
    ...
    <div class="quote-header">
      ...
      <div class="quote-price-block" data-live-symbol="${e}">
        ...
        <span class="quote-change ${d}" data-live="pct">${mr(l.change)} (${W(l.changePct)})</span>
...
(or visit Alerts page)`,`price_above`);if(!t)return;let n=prompt(`Threshold value:`,String(l.price));n!=null&&(qn({symbol:e,type:t,value:n,note:`Quick alert from quote panel`}),H(`Alert set for ${e}`,`success`))}),J.querySelector(`#qa-fav`)?.addEventListener(`click`,()=>{let t=Mn(e),n=J.querySelector(`#qa-fav`);n.textContent=t?`★ Favorited`:`☆ Favorite`,n.classList.toggle(`starred`,t),H(t?`${e} favorited`:`${e} unfavorited`,`info`)}),J.querySelector(`#qa-compare`)?.addEventListener(`click`,()=>{let t=Hn(e),n=J.querySelector(`#qa-compare`);if(Vn().length>4&&!t){H(`Compare list full (max 4)`,`error`);return}n.textContent=t?`In Compare`:`+ Compare`,n.classList.toggle(`active`,t),H(t?`${e} added to compare`:`${e} removed`,`info`)});let y=J.querySelector(`#quote-chart`),b=z().chartTheme||`dark`;y&&(Jr(y,u,{height:180,showVolume:!0,theme:b}),new ResizeObserver(()=>Jr(y,u,{height:180,showVolume:!0,theme:b})).observe(y))}var fi,pi,mi,hi=0,gi=[];function _i(){fi=document.getElementById(`command-palette`),pi=document.getElementById(`cmd-input`),mi=document.getElementById(`cmd-results`);let e=document.getElementById(`cmd-overlay`);document.addEventListener(`keydown`,e=>{if((e.ctrlKey||e.metaKey)&&e.key===`k`&&(e.preventDefault(),yi()),e.key===`/`&&!vi()){if(!fi?.hidden)return;e.preventDefault(),yi()}}),e?.addEventListener(`click`,bi),pi?.addEventListener(`input`,()=>xi(pi.value)),pi?.addEventListener(`keydown`,e=>{e.key===`Escape`&&bi(),e.key===`ArrowDown`&&(e.preventDefault(),Si(1)),e.key===`ArrowUp`&&(e.preventDefault(),Si(-1)),e.key===`Enter`&&Ci()})}function vi(){let e=document.activeElement?.tagName;return e===`INPUT`||e===`TEXTAREA`||e===`SELECT`}function yi(){fi&&(fi.hidden=!1,document.getElementById(`cmd-overlay`).hidden=!1,pi.value=``,hi=0,xi(``),requestAnimationFrame(()=>pi?.focus()))}function bi(){fi&&(fi.hidden=!0,document.getElementById(`cmd-overlay`).hidden=!0)}function xi(e){let t=e.trim().toLowerCase(),n=B();gi=E().filter(e=>t?e.symbol.toLowerCase().includes(t)||e.name.toLowerCase().includes(t):!0).slice(0,12),mi.innerHTML=gi.map((e,t)=>{let r=n.get(e.symbol),i=r?G(r.changePct):``;return`
      ...
      ${t.map((e,t)=>`
        <article class="home-index-card ${G(e.changePct)}" data-symbol="${e.navigateSymbol}" data-idx="${t}" title="Open ${e.label}">
          <div class="home-index-head">
            ...
            <span class="home-index-price" data-live="price">${Ki(e.price,e.decimals)}</span>
  ...
  `;let n=e.querySelectorAll(`.home-index-chart`),r=[];return t.forEach((e,t)=>{let i=n[t];if(!i)return;let a=()=>{let t=i.parentElement?.clientWidth||180;xr(i,e.history,{width:t,height:72,positive:e.changePct>=0})};a();let o=new ResizeObserver(a);o.observe(i.parentElement),r.push(o)}),e.querySelectorAll(`.home-index-card`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.symbol;t&&window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:t}))})}),()=>r.forEach(e=>e.disconnect())}function Ki(e,t=2){return e?e>=1e4?e.toLocaleString(`en-US`,{maximumFractionDigits:0}):e>=1e3?e.toLocaleString(`en-US`,{minimumFractionDigits:2,maximumFractionDigits:2}):e.toFixed(t):`—`}var qi=[{signal:`top_gainers`,limit:7,sort:(e,t)=>t.changePct-e.changePct},{signal:`new_high`,limit:4,sort:(e,t)=>t.changePct-e.changePct},{signal:`overbought`,limit:2,sort:(e,t)=>(t.ta?.rsi??0)-(e.ta?.rsi??0)},{signal:`unusual_volume`,limit:4,sort:(e,t)=>(t.ta?.relVolume??0)-(e.ta?.relVolume??0)}],Ji=[{signal:`top_losers`,limit:7,sort:(e,t)=>e.changePct-t.changePct},{signal:`new_low`,limit:4,sort:(e,t)=>e.changePct-t.changePct},{signal:`oversold`,limit:2,sort:(e,t)=>(e.ta?.rsi??100)-(t.ta?.rsi??100)},{signal:`most_volatile`,limit:2,sort:(e,t)=>Math.abs(t.changePct)-Math.abs(e.changePct)},{signal:`most_active`,limit:2,sort:(e,t)=>(t.volume??0)-(e.volume??0)}];async function Yi(e){let t=B(),n=z(),r=[...t.values()],i=dt(t),[a,o,s]=await Promise.all([Gt(n).catch(()=>[]),qt(n).catch(()=>null),Ui(n,t).catch(()=>[])]),c=o?.earnings?.length?o.earnings:Mi,l=o?.economic?.length?o.economic:Ni,u=o?.insider?.length?o.insider:ji,d=o?.futures?.length?o.futures:Oi,f=o?.forex?.length?o.forex:ki,p=o?.bonds?.length?o.bonds:Ai,m=Xi(r,qi),h=Xi(r,Ji),g=c.filter(e=>/BMO|before/i.test(e.date)),_=c.filter(e=>/AMC|after|Today/i.test(e.date)),v=u.filter(e=>e.type===`Buy`).slice(0,2),y=u.filter(e=>e.type===`Sale`).slice(0,2),b=r.filter(e=>Math.abs(e.changePct)>=1.5).sort((e,t)=>Math.abs(t.changePct)-Math.abs(e.changePct)).slice(0,12),x=Fi.slice(0,7),S=Fi.slice(7,14);e.innerHTML=`
    <div class="finviz-home">
      ${a[0]?`
        <div class="home-market-line panel">
          <span class="home-market-time">${ta(a[0].datetime)}</span>
          ...
          <div class="headline-list home-headlines">
            ${a.slice(0,6).map(e=>`
              <a class="headline-item" href="${e.url||`#`}" target="_blank" rel="noopener">
                <span class="headline-time">${ta(e.datetime)}</span>
  ...
  `;let C=e.querySelector(`#home-indices`);C&&s.length&&Gi(C,s);let w=e.querySelector(`#home-heatmap`);w&&Ti(w,r,e=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e}))}),e.querySelectorAll(`[data-symbol]`).forEach(e=>{e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})})}function Xi(e,t){let n=[];for(let{signal:r,limit:i,sort:a}of t){let t=Pi.find(e=>e.id===r)?.label||r,o=e.filter(e=>e.signals?.some(e=>e.id===r)).sort(a).slice(0,i);for(let e of o)n.push({quote:e,signal:r,signalLabel:t})}return n}function Zi(e){return`
  ...
  `}function Qi(e,t){return e.length?`
  ...
  `:``}function $i(e,t){return e.length?`
    <table class="data-table compact finviz-tbl home-tape-tbl home-tape-extra">
      <tbody>
        ${e.map(e=>`
          <tr class="clickable" data-symbol="${e.symbol}">
  ...
  `}function ta(e){return e?(typeof e==`number`?new Date(e*1e3):new Date(e)).toLocaleTimeString(`en-US`,{hour:`2-digit`,minute:`2-digit`}):``}var na=[{id:`all`,label:`All Stocks`,filters:{}},{id:`gainers`,label:`Top Gainers`,filters:{signal:`top_gainers`}},{id:`losers`,label:`Top Losers`,filters:{signal:`top_losers`}},{id:`newhigh`,label:`New High`,filters:{signal:`new_high`}},{id:`newlow`,label:`New Low`,filters:{signal:`new_low`}},{id:`overbought`,label:`Overbought`,filters:{signal:`overbought`}},{id:`oversold`,label:`Oversold`,filters:{signal:`oversold`}},{id:`unusualvol`,label:`Unusual Volume`,filters:{signal:`unusual_volume`}},{id:`golden`,label:`Golden Cross`,filters:{signal:`golden_cross`}},{id:`doublebottom`,label:`Double Bottom`,filters:{pattern:`double_bottom`}},{id:`headshoulders`,label:`Head & Shoulders`,filters:{pattern:`head_shoulders`}},{id:`bullish`,label:`Bullish Prediction`,filters:{prediction:`bullish`}},{id:`bearish`,label:`Bearish Prediction`,filters:{prediction:`bearish`}},{id:`tech`,label:`Technology`,filters:{sector:`Technology`}},{id:`megacap`,label:`Mega Cap`,filters:{minMarketCap:`200000000000`}},{id:`value`,label:`Value (Low P/E)`,filters:{maxPe:`20`,minDivYield:`1`}},{id:`growth`,label:`Growth (Low PEG)`,filters:{maxPeg:`1.5`,minChange:`0`}},{id:`dividend`,label:`Dividend`,filters:{minDivYield:`2`}},{id:`momentum`,label:`Momentum`,filters:{minChange:`2`,aboveSma50:`yes`}},{id:`rsi30`,label:`RSI Oversold`,filters:{maxRsi:`30`}},{id:`rsi70`,label:`RSI Overbought`,filters:{minRsi:`70`}},{id:`healthcare`,label:`Healthcare`,filters:{sector:`Healthcare`}},{id:`financial`,label:`Financial`,filters:{sector:`Financial`}}],ra=new Set(`price.changePct.volume.marketCap.rsi.pe.peFwd.peg.ps.pb.eps.epsFwd.epsGrowth.beta.dividendYield.payoutRatio.grossMargin.netMargin.roe.relVolume.sma20.sma50.sma200.predConf.atr.shortPct.instPct`.split(`.`)),ia={rsi:e=>e.ta?.rsi??50,pe:e=>e.fundamentals?.pe??0,peFwd:e=>e.fundamentals?.peFwd??0,peg:e=>e.fundamentals?.peg??0,ps:e=>e.fundamentals?.ps??0,pb:e=>e.fundamentals?.pb??0,eps:e=>e.fundamentals?.eps??0,epsFwd:e=>e.fundamentals?.epsFwd??0,epsGrowth:e=>e.fundamentals?.epsGrowth??0,beta:e=>e.fundamentals?.beta??1,dividendYield:e=>e.fundamentals?.dividendYield??0,payoutRatio:e=>e.fundamentals?.payoutRatio??0,grossMargin:e=>e.fundamentals?.grossMargin??0,netMargin:e=>e.fundamentals?.netMargin??0,roe:e=>e.fundamentals?.roe??0,shortPct:e=>e.fundamentals?.shortPct??0,instPct:e=>e.fundamentals?.instPct??0,relVolume:e=>e.ta?.relVolume??1,sma20:e=>e.ta?.sma20??e.price,sma50:e=>e.ta?.sma50??e.price,sma200:e=>e.ta?.sma200??e.price,predConf:e=>e.prediction?.confidence??50,atr:e=>e.ta?.atr??0,price:e=>e.price??0,changePct:e=>e.changePct??0,volume:e=>e.volume??0,marketCap:e=>e.marketCap??0};function aa(e){let t={};for(let[n,r]of Object.entries(ia))t[n]=r(e);return t}function oa(e){if(!e?.trim())return{valid:!0,error:null};try{return la(ca(e),0),{valid:!0,error:null}}catch(e){return{valid:!1,error:e.message}}}function sa(e,t){if(!e?.trim())return!0;let n=aa(t);return!!la(ca(e),0,n).value}function ca(e){let t=[],n=0;for(;n<e.length;){let r=e[n];if(/\s/.test(r)){n++;continue}if(/[0-9.]/.test(r)){let r=``;for(;n<e.length&&/[0-9.]/.test(e[n]);)r+=e[n++];t.push({type:`num`,value:parseFloat(r)});continue}if(/[a-zA-Z_]/.test(r)){let r=``;for(;n<e.length&&/[a-zA-Z0-9_]/.test(e[n]);)r+=e[n++];let i=r.toLowerCase();if(i===`and`)t.push({type:`op`,value:`&&`});else if(i===`or`)t.push({type:`op`,value:`||`});else if(i===`not`)t.push({type:`op`,value:`!`});else if(ra.has(r))t.push({type:`id`,value:r});else throw Error(`Unknown field: ${r}`);continue}if(`+-*/<>=!&|()`.includes(r)){let i=r+(e[n+1]||``);[`>=`,`<=`,`==`,`!=`,`&&`,`||`].includes(i)?(t.push({type:`op`,value:i}),n+=2):(t.push({type:`op`,value:r}),n++);continue}throw Error(`Invalid character: ${r}`)}return t}function la(e,t,n=null){return ua(e,t,n)}function ua(e,t,n){let r=da(e,t,n);for(t=r.pos;e[t]?.value===`||`;){let i=da(e,t+1,n);r={value:r.value||i.value,pos:i.pos},t=i.pos}return r}function da(e,t,n){let r=fa(e,t,n);for(t=r.pos;e[t]?.value===`&&`;){let i=fa(e,t+1,n);r={value:r.value&&i.value,pos:i.pos},t=i.pos}return r}function fa(e,t,n){let r=pa(e,t,n);if(t=r.pos,[`>=`,`<=`,`==`,`!=`,`>`,`<`].includes(e[t]?.value)){let i=e[t].value,a=pa(e,t+1,n),o=r.value,s=a.value,c=!1;return i===`>`?c=o>s:i===`<`?c=o<s:i===`>=`?c=o>=s:i===`<=`?c=o<=s:i===`==`?c=o===s:i===`!=`&&(c=o!==s),{value:c,pos:a.pos}}return r}function pa(e,t,n){let r=ma(e,t,n);for(t=r.pos;e[t]?.value===`+`||e[t]?.value===`-`;){let i=e[t].value,a=ma(e,t+1,n);r={value:i===`+`?r.value+a.value:r.value-a.value,pos:a.pos},t=a.pos}return r}function ma(e,t,n){let r=ha(e,t,n);for(t=r.pos;e[t]?.value===`*`||e[t]?.value===`/`;){let i=e[t].value,a=ha(e,t+1,n);r={value:i===`*`?r.value*a.value:r.value/a.value,pos:a.pos},t=a.pos}return r}function ha(e,t,n){if(e[t]?.value===`!`){let r=ha(e,t+1,n);return{value:!r.value,pos:r.pos}}if(e[t]?.value===`-`){let r=ha(e,t+1,n);return{value:-r.value,pos:r.pos}}return ga(e,t,n)}function ga(e,t,n){let r=e[t];if(!r)throw Error(`Unexpected end of formula`);if(r.type===`num`)return{value:r.value,pos:t+1};if(r.type===`id`)return n?{value:n[r.value]??0,pos:t+1}:{value:0,pos:t+1};if(r.value===`(`){let r=la(e,t+1,n);if(e[r.pos]?.value!==`)`)throw Error(`Missing )`);return{value:r.value,pos:r.pos+1}}throw Error(`Unexpected token: ${r.value}`)}var _a=[{label:`Oversold bounce`,formula:`rsi < 35 and changePct > 0`},{label:`Value + PEG`,formula:`peg < 1.5 and pe < 25 and epsGrowth > 5`},{label:`Dividend value`,formula:`dividendYield > 2 and pe < 20 and payoutRatio < 60`},{label:`Growth at reasonable price`,formula:`peg < 2 and epsGrowth > 10 and ps < 8`},{label:`High volume breakout`,formula:`relVolume > 1.5 and changePct > 2`}];function va(e,t){return[...e.values()].filter(e=>{if(t.search){let n=t.search.toLowerCase();if(!e.symbol.toLowerCase().includes(n)&&!(e.name||``).toLowerCase().includes(n))return!1}return!(t.sector&&e.sector!==t.sector||t.industry&&e.industry!==t.industry||t.minChange!==``&&e.changePct<Number(t.minChange)||t.maxChange!==``&&e.changePct>Number(t.maxChange)||t.minVolume!==``&&(e.volume||0)<Number(t.minVolume)||t.minMarketCap!==``&&(e.marketCap||0)<Number(t.minMarketCap)||t.minRsi!==``&&(e.ta?.rsi??50)<Number(t.minRsi)||t.maxRsi!==``&&(e.ta?.rsi??50)>Number(t.maxRsi)||t.minPe!==``&&(e.fundamentals?.pe??0)<Number(t.minPe)||t.maxPe!==``&&(e.fundamentals?.pe??999)>Number(t.maxPe)||t.minPeg!==``&&(e.fundamentals?.peg??0)<Number(t.minPeg)||t.maxPeg!==``&&(e.fundamentals?.peg??999)>Number(t.maxPeg)||t.minDivYield!==``&&(e.fundamentals?.dividendYield??0)<Number(t.minDivYield)||t.signal&&!e.signals?.some(e=>e.id===t.signal)||t.pattern&&!e.patterns?.some(e=>e.id===t.pattern)||t.prediction&&e.prediction?.direction!==t.prediction||t.aboveSma50===`yes`&&!(e.ta?.sma50&&e.price>e.ta.sma50)||t.aboveSma50===`no`&&e.ta?.sma50&&e.price>e.ta.sma50||t.aboveSma200===`yes`&&!(e.ta?.sma200&&e.price>e.ta.sma200)||t.aboveSma200===`no`&&e.ta?.sma200&&e.price>e.ta.sma200||t.formula&&!sa(t.formula,e))})}var ya=`Symbol.Company.Sector.Industry.Price.Change.Change %.Volume.Market Cap.RSI.SMA20.SMA50.SMA200.P/E.Forward P/E.PEG.P/S.P/B.EV/EBITDA.EPS.EPS Fwd.EPS Growth.Div Yield.Beta.52W High.52W Low.ROE.Net Margin.Short %.Primary Signal.Pattern.Prediction.Confidence.Target.Target %`.split(`.`);function ba(e){let t=String(e??``);return t.includes(`,`)||t.includes(`"`)?`"${t.replace(/"/g,`""`)}"`:t}function xa(e){return[e.symbol,ba(e.name),ba(e.sector),ba(e.industry),U(e.price),e.change?.toFixed(2)??``,e.changePct?.toFixed(2)??``,e.volume??``,e.marketCap??``,e.ta?.rsi?.toFixed(1)??``,e.ta?.sma20?.toFixed(2)??``,e.ta?.sma50?.toFixed(2)??``,e.ta?.sma200?.toFixed(2)??``,e.fundamentals?.pe??``,e.fundamentals?.peFwd??``,e.fundamentals?.peg??``,e.fundamentals?.ps??``,e.fundamentals?.pb??``,e.fundamentals?.evEbitda??``,e.fundamentals?.eps??``,e.fundamentals?.epsFwd??``,e.fundamentals?.epsGrowth??``,e.fundamentals?.dividendYield??``,e.fundamentals?.beta??``,e.fundamentals?.high52??``,e.fundamentals?.low52??``,e.fundamentals?.roe??``,e.fundamentals?.netMargin??``,e.fundamentals?.shortPct??``,ba(e.primarySignal),ba(e.patternLabels?.join(`; `)),e.prediction?.direction??``,e.prediction?.confidence??``,e.prediction?.priceTarget??``,e.prediction?.targetPct??``].join(`,`)}function Sa(e){return{symbol:e.symbol,name:e.name,sector:e.sector,industry:e.industry,price:e.price,change:e.change,changePct:e.changePct,volume:e.volume,marketCap:e.marketCap,ta:e.ta,fundamentals:e.fundamentals,signals:e.signals?.map(e=>e.label),patterns:e.patterns,prediction:e.prediction,timestamp:e.timestamp}}function Ca(e,t=`stockviz-export.csv`,n=!1){Da([(n?ya:[`Symbol`,`Company`,`Sector`,`Price`,`Change`,`Change %`,`Volume`,`Market Cap`]).join(`,`),...e.map(e=>n?xa(e):[e.symbol,ba(e.name),ba(e.sector),U(e.price),e.change?.toFixed(2)??``,e.changePct?.toFixed(2)??``,e.volume??``,e.marketCap??``].join(`,`))].join(`
`),t,`text/csv;charset=utf-8`)}function wa(e,t=`stockviz-export.json`){let n={exportedAt:new Date().toISOString(),count:e.length,stocks:e.map(Sa)};Da(JSON.stringify(n,null,2),t,`application/json`)}function Ta(e){return{api:`StockViz Export API v1`,version:`1.0`,exportedAt:new Date().toISOString(),count:e.length,endpoints:{screener:`GET /api/v1/screener — full universe with TA`,quote:`GET /api/v1/quote?symbol=AAPL — single stock`,signals:`GET /api/v1/signals — stocks by signal`,patterns:`GET /api/v1/patterns — pattern scanner results`},data:e.map(Sa)}}async function Ea(e){let t=Ta(e);return await navigator.clipboard.writeText(JSON.stringify(t,null,2)),t.count}function Da(e,t,n){let r=new Blob([e],{type:n}),i=document.createElement(`a`);i.href=URL.createObjectURL(r),i.download=t,i.click(),URL.revokeObjectURL(i.href)}var Oa=[`sector`,`industry`,`minChange`,`maxChange`,`minVolume`,`minMarketCap`,`search`,`signal`,`pattern`,`prediction`,`minRsi`,`maxRsi`,`minPe`,`maxPe`,`minPeg`,`maxPeg`,`minDivYield`,`aboveSma50`,`aboveSma200`,`formula`];function ka(){let e=location.hash.slice(1),t=e.indexOf(`?`);if(t===-1)return null;let n=new URLSearchParams(e.slice(t+1)),r={};for(let e of Oa){let t=n.get(e);t!=null&&(r[e]=t)}return Object.keys(r).length?r:null}function Aa(e){let t=location.hash.slice(1).split(`?`)[0]||`/`;if(t!==`/screener`&&t!==`/map`)return;let n=new URLSearchParams;for(let t of Oa)e[t]&&n.set(t,e[t]);let r=n.toString(),i=r?`#${t}?${r}`:`#${t}`;location.hash!==i&&history.replaceState(null,``,i)}function ja(){let e=ka();e&&xn(e,{preset:`custom`})}function Ma(e){let t=new URLSearchParams;for(let n of Oa)e[n]&&t.set(n,e[n]);let n=t.toString(),r=location.origin+location.pathname;return n?`${r}#/screener?${n}`:`${r}#/screener`}function Na(e,t=200){let n;return(...r)=>{clearTimeout(n),n=setTimeout(()=>e(...r),t)}}var Pa=[{id:`rsi`,label:`RSI`,type:`number`},{id:`changePct`,label:`Change %`,type:`number`},{id:`pe`,label:`P/E`,type:`number`},{id:`peg`,label:`PEG`,type:`number`},{id:`relVolume`,label:`Rel Volume`,type:`number`},{id:`predConf`,label:`Pred Confidence`,type:`number`},{id:`volume`,label:`Volume`,type:`number`},{id:`marketCap`,label:`Market Cap`,type:`number`}],Fa=[`<`,`>`,`<=`,`>=`,`==`,`!=`];function Ia(e,{current:t=``,onApply:n}){let r=`rsi`,i=`<`,a=`35`,o=`and`;function s(){return`${r} ${i} ${a}`}function c(){e.innerHTML=`
      <div class="formula-builder panel">
        <h4 class="panel-title">Visual Formula Builder</h4>
        <div class="fb-row">
          <select id="fb-field">${Pa.map(e=>`<option value="${e.id}">${e.label}</option>`).join(``)}</select>
          <select id="fb-op">${Fa.map(e=>`<option value="${e}">${e}</option>`).join(``)}</select>
    ...
    `,e.querySelector(`#fb-field`).value=r,e.querySelector(`#fb-op`).value=i;let c=e.querySelector(`#fb-out`),l=()=>{r=e.querySelector(`#fb-field`).value,i=e.querySelector(`#fb-op`).value,a=e.querySelector(`#fb-val`).value,o=e.querySelector(`#fb-conn`).value,c.textContent=s()};e.querySelectorAll(`select, input`).forEach(e=>e.addEventListener(`change`,l)),e.querySelector(`#fb-val`)?.addEventListener(`input`,l),e.querySelector(`#fb-append`)?.addEventListener(`click`,()=>{let e=s(),n=c.textContent&&c.textContent!==s()?c.textContent:t||``;c.textContent=n?`${n} ${o} ${e}`:e}),e.querySelector(`#fb-apply`)?.addEventListener(`click`,()=>{n?.(c.textContent)})}c()}function La(t){let n=bn(),r=wn(),i=Cn(),a=nr(),o=B(),s=Ba(va(o,n),r);Aa(n),t.innerHTML=`
    ...
    <form class="filter-bar" id="filter-form">
      ...
      <div class="filter-panel" data-panel="formula" hidden>
        <div class="filter-group formula-group">
          ...
          <span class="formula-status ${oa(n.formula).valid?`ok`:n.formula?`err`:``}" id="formula-status">
            ${n.formula&&!oa(n.formula).valid?oa(n.formula).error:`Fields: price, changePct, rsi, pe, relVolume, sma20, predConf…`}
          </span>
        </div>
        <div class="formula-examples">
          ${_a.map(e=>`<button type="button" class="preset-chip formula-chip" data-formula="${X(e.formula)}">${e.label}</button>`).join(``)}
        </div>
    ...
    <div class="table-wrap screener-scroll">
      <table class="data-table screener-table" id="screener-table">
        ...
        <tbody>
          ${s.length?s.map(Ra).join(``):`<tr><td colspan="18" class="empty-row">No matches — adjust filters</td></tr>`}
        </tbody>
      </table>
    </div>
  `;let c=t.querySelector(`#filter-form`),l=Na(()=>{let e=new FormData(c);xn(Object.fromEntries(e.entries()),{preset:`custom`})},180);c.addEventListener(`input`,l),c.addEventListener(`change`,()=>{let e=new FormData(c);xn(Object.fromEntries(e.entries()),{preset:`custom`})}),t.querySelector(`#reset-filters`)?.addEventListener(`click`,lr),t.querySelector(`#save-filter`)?.addEventListener(`click`,()=>{let e=prompt(`Name this filter preset:`);e?.trim()&&rr(e.trim())}),t.querySelectorAll(`[data-preset]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=na.find(t=>t.id===e.dataset.preset);t&&Sn(t.id,t.filters)})}),t.querySelectorAll(`[data-saved]`).forEach(e=>{e.addEventListener(`click`,()=>ar(e.dataset.saved))}),t.querySelectorAll(`[data-del]`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),ir(e.dataset.del)})}),t.querySelector(`#export-csv`)?.addEventListener(`click`,()=>Ca(s)),t.querySelector(`#export-full`)?.addEventListener(`click`,()=>Ca(s,`stockviz-screener-ta.csv`,!0)),t.querySelector(`#share-screener`)?.addEventListener(`click`,async()=>{let e=Ma(n);try{await navigator.clipboard.writeText(e);let n=t.querySelector(`#share-screener`),r=n.textContent;n.textContent=`Copied!`,setTimeout(()=>{n.textContent=r},2e3)}catch{prompt(`Copy this link:`,e)}}),t.querySelectorAll(`th[data-sort]`).forEach(e=>{e.addEventListener(`click`,()=>Tn(e.dataset.sort))}),t.querySelectorAll(`[data-symbol]`).forEach(e=>{e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})}),t.querySelectorAll(`.screener-tab`).forEach(e=>{e.addEventListener(`click`,()=>{t.querySelectorAll(`.screener-tab`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let n=e.dataset.tab;t.querySelectorAll(`.filter-panel`).forEach(e=>{e.hidden=e.dataset.panel!==n})})}),t.querySelectorAll(`[data-fav]`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=Mn(e.dataset.fav);e.textContent=n?`★`:`☆`,e.classList.toggle(`starred`,n)})});let u=t.querySelector(`#formula-builder-host`);u&&Ia(u,{current:n.formula,onApply:e=>{let n=t.querySelector(`#formula-input`);n&&(n.value=e),xn({formula:e},{preset:`custom`})}}),t.querySelectorAll(`[data-formula]`).forEach(e=>{e.addEventListener(`click`,()=>{let n=t.querySelector(`#formula-input`);n&&(n.value=e.dataset.formula,xn({formula:e.dataset.formula},{preset:`custom`}))})})}function Y(e,t,n){return`<th data-sort="${e}" class="sortable">${t}${n.key===e?n.dir===`asc`?` ▲`:` ▼`:``}</th>`}function Ra(e){let t=Nn(e.symbol);return`
    <tr class="clickable" data-live-symbol="${e.symbol}" data-symbol="${e.symbol}">
      <td class="col-star">
  ...
  `}function za(e,t){return t.includes(`.`)?t.split(`.`).reduce((e,t)=>e?.[t],e):e[t]}function Ba(e,{key:t,dir:n}){let r=n===`asc`?1:-1;return[...e].sort((e,n)=>{let i=za(e,t)??``,a=za(n,t)??``;return typeof i==`number`&&typeof a==`number`?(i-a)*r:String(i).localeCompare(String(a))*r})}function X(e){return String(e??``).replace(/"/g,`&quot;`)}function Va(e){let t=va(B(),bn());e.innerHTML=`
  ...
  `,Ti(e.querySelector(`#heatmap-root`),t,e=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e}))})}async function Ha(e){e.innerHTML=`
    <div class="page-header">
      <h1>Market News</h1>
      <p class="page-sub">Latest headlines from your data feed.</p>
    </div>
    <div class="news-loading panel">Loading news…</div>
  `;let t=await Gt(z()),n=e.querySelector(`.news-loading`);n&&(n.className=`news-list panel`,n.innerHTML=t.length?t.map(Ua).join(``):`<p class="muted">No news available.</p>`,n.querySelectorAll(`[data-symbol]`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})}))}function Ua(e){let t=e.datetime?new Date(e.datetime*1e3).toLocaleString(`en-US`,{month:`short`,day:`numeric`,hour:`2-digit`,minute:`2-digit`}):``,n=e.related?.split(`,`)[0]||e.symbol;return`
  ...
  `}function Wa(e){let t=Pn(),n=B(),r=0,i=0,a=t.map(e=>{let t=n.get(e.symbol),a=t?.price??0,o=a*e.shares,s=e.costBasis*e.shares,c=o-s,l=s?c/s*100:0;return r+=o,i+=s,{...e,q:t,price:a,value:o,cost:s,pl:c,plPct:l}}),o=r-i,s=i?o/i*100:0;e.innerHTML=`
    <div class="page-header">
      <h1>Portfolio</h1>
    ...
    <div class="table-wrap">
      <table class="data-table">
        ...
        <tbody>
          ${a.length?a.map(Ga).join(``):`<tr><td colspan="8" class="empty-row">No holdings yet — add your first position above.</td></tr>`}
        </tbody>
      </table>
    </div>
  `,e.querySelector(`#add-holding`)?.addEventListener(`submit`,e=>{e.preventDefault();let t=new FormData(e.target),n=t.get(`symbol`).toString().trim().toUpperCase();if(!Ne(n)){H(`Symbol not in universe`,`error`);return}Fn({symbol:n,shares:t.get(`shares`),costBasis:t.get(`costBasis`)}),H(`Added ${n}`,`success`),e.target.reset()}),e.querySelectorAll(`[data-remove]`).forEach(e=>{e.addEventListener(`click`,()=>{In(e.dataset.remove),H(`Removed ${e.dataset.remove}`,`info`)})}),e.querySelectorAll(`[data-symbol]`).forEach(e=>{e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})})}function Ga(e){return`
  ...
  `}var Ka=[{key:`price`,label:`Price`,fmt:e=>`$${U(e.price)}`},{key:`changePct`,label:`Change %`,fmt:e=>W(e.changePct),cls:e=>G(e.changePct)},{key:`volume`,label:`Volume`,fmt:e=>hr(e.volume)},{key:`marketCap`,label:`Market Cap`,fmt:e=>gr(e.marketCap)},{key:`pe`,label:`P/E (TTM)`,fmt:e=>e.fundamentals?.pe??`—`},{key:`peg`,label:`PEG`,fmt:e=>e.fundamentals?.peg??`—`},{key:`eps`,label:`EPS`,fmt:e=>e.fundamentals?.eps==null?`—`:e.fundamentals.eps.toFixed(2)},{key:`ps`,label:`P/S`,fmt:e=>e.fundamentals?.ps??`—`},{key:`pb`,label:`P/B`,fmt:e=>e.fundamentals?.pb??`—`},{key:`div`,label:`Div Yield`,fmt:e=>e.fundamentals?.dividendYield==null?`—`:`${e.fundamentals.dividendYield}%`},{key:`beta`,label:`Beta`,fmt:e=>e.fundamentals?.beta??`—`},{key:`rsi`,label:`RSI`,fmt:e=>e.ta?.rsi?.toFixed(1)??`—`},{key:`prediction`,label:`Prediction`,fmt:e=>e.prediction?`${e.prediction.direction} ${e.prediction.confidence}%`:`—`,cls:e=>e.prediction?.direction===`bullish`?`pos`:e.prediction?.direction===`bearish`?`neg`:``},{key:`sector`,label:`Sector`,fmt:e=>e.sector||`—`}];function qa(e){let t=Vn(),n=B();e.innerHTML=`
  ...
  `}function Ya(e){let t=[...B().values()];e.innerHTML=`
    <div class="page-header">
  ...
  `,e.querySelectorAll(`[data-symbol]`).forEach(e=>{e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})})}function Xa(e){let t=[...B().values()],n=t.flatMap(e=>(e.patterns||[]).map(t=>({...e,pattern:t}))).sort((e,t)=>t.pattern.confidence-e.pattern.confidence);e.innerHTML=`
    <div class="page-header">
  ...
  `,e.querySelectorAll(`[data-symbol]`).forEach(e=>{e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})})}function Za(t){let n=[...B().values()];t.innerHTML=`
    <div class="page-header">
      <h1>Groups</h1>
  ...
  `}var Qa=`AAPL`,Z={overlays:{sma20:!0,sma50:!0,sma200:!1,bollinger:!1},showVolume:!0,showRsi:!0};function $a(e){let t=B(),n=t.get(Qa)||t.get(`AAPL`);e.innerHTML=`
    <div class="page-header charts-header">
      <h1>Advanced Charts</h1>
      <select id="chart-symbol" class="chart-select">
        ${E().map(e=>`<option value="${e.symbol}" ${e.symbol===Qa?`selected`:``}>${e.symbol} — ${e.name}</option>`).join(``)}
      </select>
    </div>
    ${n?`
  ...
  `}async function to(e){let t=await qt(z()).catch(()=>null),n=t?.futures?.length?t.futures:Oi,r=t?.forex?.length?t.forex:ki,i=t?.bonds?.length?t.bonds:Ai;e.innerHTML=`
    <div class="page-header">
      <h1>Futures &amp; Forex</h1>
    ...
    <div class="three-col">
      ${eo(`Futures`,n,[`Contract`,`Last`,`Change`,`Change %`])}
      ${eo(`Forex & Crypto`,r,[`Pair`,`Last`,`Change`,`Change %`])}
      ${eo(`Bonds`,i,[`Bond`,`Yield`,`Change`,`Change %`])}
    </div>
  `}async function no(e){let t=await qt(z()).catch(()=>null),n=t?.earnings?.length?t.earnings:Mi,r=t?.economic?.length?t.economic:Ni;e.innerHTML=`
    <div class="page-header">
  ...
  `,e.querySelectorAll(`[data-symbol]`).forEach(e=>{e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})})}async function ro(e){let t=await qt(z()).catch(()=>null),n=t?.insider?.length?t.insider:ji;e.innerHTML=`
    <div class="page-header">
  ...
  `,e.querySelectorAll(`[data-symbol]`).forEach(e=>{e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})})}function io(){return`Notification`in window}function ao(){return io()?Notification.permission:`unsupported`}async function oo(){return io()?Notification.permission===`granted`?`granted`:Notification.permission===`denied`?`denied`:await Notification.requestPermission():`unsupported`}function so({title:e,body:t,tag:n}){if(!io()||Notification.permission!==`granted`)return!1;try{return new Notification(e,{body:t,tag:n||`stockviz-alert`,icon:`/favicon.svg`,silent:!1}),!0}catch{return!1}}async function Q(e,t){let n=Date.now();try{let r=await t(),i=r!=null&&(!Array.isArray(r)||r.length>0);return{name:e,ok:i,ms:Date.now()-n,detail:i?`Live`:`Empty response`}}catch(t){return{name:e,ok:!1,ms:Date.now()-n,detail:t.message||`Failed`}}}async function co(e){let t=e?.trim();if(!t)return{valid:!1,results:[],message:`No FMP API key`};let n=await Promise.all([Q(`Stock Quote`,()=>f(`AAPL`,t)),Q(`Batch Quotes`,()=>d([`AAPL`,`MSFT`],t).then(e=>[...e.values()])),Q(`S&P 500 List`,()=>xe(t)),Q(`Ratios TTM`,()=>m(`AAPL`,t)),Q(`General News`,()=>v(t,3)),Q(`Earnings Calendar`,()=>x(t)),Q(`Insider Trades`,()=>w(t,5)),Q(`Analyst Grades`,()=>ue(`AAPL`,t)),Q(`Short Interest`,()=>me(`AAPL`,t)),Q(`Options Chain`,()=>ge(`AAPL`,t)),Q(`Financials`,()=>ve(`AAPL`,t)),Q(`SEC Filings`,()=>be(`AAPL`,t)),Q(`Dividend Calendar`,()=>Se(t)),Q(`After-Hours Quote`,()=>Ce(`AAPL`,t))]),r=n.filter(e=>e.ok).length;return{valid:r>0,live:r,total:n.length,results:n,message:`${r}/${n.length} endpoints returned live data`}}var lo=1;function uo(){let e=[`stockviz-settings`,`stockviz-favorites`,`stockviz-portfolio`,`stockviz-alerts`,`stockviz-saved-filters`,`stockviz-multichart`,`stockviz-paper-trades`],t={version:lo,exportedAt:Date.now(),data:{}};for(let n of e)try{let e=localStorage.getItem(n);e&&(t.data[n]=JSON.parse(e))}catch{}return t}function fo(e){if(!e?.data||e.version!==lo)throw Error(`Invalid settings bundle`);for(let[t,n]of Object.entries(e.data))localStorage.setItem(t,JSON.stringify(n));return Object.keys(e.data).length}function po(){let e=uo(),t=new Blob([JSON.stringify(e,null,2)],{type:`application/json`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=`stockviz-settings-${new Date().toISOString().slice(0,10)}.json`,r.click(),URL.revokeObjectURL(n)}async function mo(){let e=uo(),t=btoa(JSON.stringify(e));return await navigator.clipboard.writeText(t),t.length}function ho(e){return fo(JSON.parse(atob(e.trim())))}function go(e){let t=z(),n=je();e.innerHTML=`
    <div class="page-header">
      <h1>Settings</h1>
    ...
    <form class="settings-form panel" id="settings-form">
      <fieldset>
        ...
        <div class="field">
          ...
          <div class="input-row">
            <input type="password" id="fmpApiKey" name="fmpApiKey" placeholder="Paste your FMP key…" value="${vo(t.fmpApiKey)}" autocomplete="off" />
        ...
        <div class="field">
          ...
          <p class="field-hint">
            Current: <strong id="universe-label">${vo(n.label)}</strong>
        ...
        <div class="field">
          ...
          <div class="input-row">
            <input type="password" id="apiKey" name="apiKey" placeholder="Paste your Finnhub key…" value="${vo(t.apiKey)}" autocomplete="off" />
      ...
      <fieldset>
        ...
        <div class="field checkbox-field">
          <label>
            <input type="checkbox" name="pushNotifications" ${t.pushNotifications?`checked`:``} ${io()?``:`disabled`} />
            Browser push notifications for alerts
          </label>
          ${io()?`<p class="field-hint">Permission: <strong>${ao()}</strong>
            ${ao()==="default"?` — save settings to request permission`:``}</p>`:`<p class="field-hint">Not supported in this browser.</p>`}
        </div>
        <div class="field checkbox-field">
          <label>
      ...
      <fieldset>
        ...
        <div class="field">
          ...
          <input type="url" id="alertWebhookUrl" name="alertWebhookUrl" placeholder="https://…" value="${vo(t.alertWebhookUrl)}" />
      ...
      <fieldset>
        ...
        <div class="field">
          ...
          <input type="text" id="watchlist" name="watchlist" value="${vo(t.watchlist.join(`, `))}" placeholder="AAPL, MSFT, NVDA" />
        </div>
      </fieldset>
  ...
  `;let r=e.querySelector(`#settings-form`);r.addEventListener(`submit`,async t=>{t.preventDefault();let n=new FormData(r),i=n.get(`watchlist`).split(`,`).map(e=>e.trim().toUpperCase()).filter(Boolean),a=n.get(`pushNotifications`)===`on`;vn({fmpApiKey:n.get(`fmpApiKey`),apiKey:n.get(`apiKey`),refreshInterval:Number(n.get(`refreshInterval`))||30,useMockData:n.get(`useMockData`)===`on`,watchlist:i,pushNotifications:a,alertSound:n.get(`alertSound`)===`on`,chartTheme:n.get(`chartTheme`)||`dark`,alertWebhookUrl:n.get(`alertWebhookUrl`)}),_t(),Ir(),Wi(),a&&ao()==="default"&&await oo(),_o(e),window.dispatchEvent(new CustomEvent(`stockviz:settings-saved`))}),e.querySelector(`#test-fmp-api`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#fmpApiKey`).value,n=e.querySelector(`#fmp-api-status`);n.textContent=`Testing…`,n.className=`api-status`;let r=await oe(t);n.textContent=r.message,n.className=`api-status ${r.valid?`ok`:`err`}`}),e.querySelector(`#audit-fmp-api`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#fmpApiKey`).value,n=e.querySelector(`#fmp-api-status`),r=e.querySelector(`#fmp-audit-results`),i=e.querySelector(`#audit-fmp-api`);n.textContent=`Running endpoint audit (~15 API calls)…`,n.className=`api-status`,i.disabled=!0,r.hidden=!0;let a=await co(t);n.textContent=a.message,n.className=`api-status ${a.valid?`ok`:`err`}`,r.hidden=!1,r.innerHTML=`
    ...
    `,i.disabled=!1}),e.querySelector(`#refresh-universe`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#refresh-universe`),n=e.querySelector(`#universe-label`);t.disabled=!0,t.textContent=`Loading…`;let r={...z(),fmpApiKey:e.querySelector(`#fmpApiKey`).value,useMockData:e.querySelector(`[name="useMockData"]`).checked},i=await Be(r);n.textContent=i.label,t.textContent=`Refresh S&P 500 List`,t.disabled=r.useMockData||!r.fmpApiKey?.trim(),_o(e,`Universe updated: ${i.label}`),window.dispatchEvent(new CustomEvent(`stockviz:settings-saved`))}),e.querySelector(`#export-settings`)?.addEventListener(`click`,()=>po()),e.querySelector(`#copy-settings`)?.addEventListener(`click`,async()=>{await mo(),_o(e,`Sync code copied to clipboard.`)}),e.querySelector(`#import-settings`)?.addEventListener(`click`,()=>{let t=prompt(`Paste your sync code:`);if(t)try{ho(t),_o(e,`Settings imported — reloading…`),setTimeout(()=>window.dispatchEvent(new CustomEvent(`stockviz:settings-saved`)),500)}catch(e){alert(e.message||`Import failed`)}}),e.querySelector(`#test-api`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#apiKey`).value,n=e.querySelector(`#api-status`);n.textContent=`Testing…`,n.className=`api-status`;let r=await Jt(t);n.textContent=r.message,n.className=`api-status ${r.valid?`ok`:`err`}`})}function _o(e,t=`Settings saved.`){let n=e.querySelector(`.save-toast`);n||(n=document.createElement(`p`),n.className=`save-toast`,e.querySelector(`.settings-form`)?.appendChild(n)),n.textContent=t,setTimeout(()=>n.remove(),2500)}function vo(e){return String(e??``).replace(/"/g,`&quot;`)}var yo=[{id:`2x2`,cols:2,slots:4},{id:`2x3`,cols:3,slots:6},{id:`3x3`,cols:3,slots:9},{id:`4x2`,cols:4,slots:8}],bo=[`AAPL`,`MSFT`,`NVDA`,`GOOGL`,`AMZN`,`META`,`TSLA`,`JPM`,`SPY`];function xo(e){let t=er(),n=yo.find(e=>e.id===t.id)||yo[0],r=B(),i=[...t.symbols];for(;i.length<n.slots;)i.push(bo[i.length%bo.length]);e.innerHTML=`
    ...
    <div class="multichart-grid cols-${n.cols}" id="mc-grid">
      ${i.slice(0,n.slots).map((e,t)=>Co(e,r.get(e),t)).join(``)}
    </div>
  `,e.querySelectorAll(`[data-layout]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=yo.find(t=>t.id===e.dataset.layout);tr({id:t.id,symbols:i.slice(0,t.slots)})})}),e.querySelector(`#mc-watchlist`)?.addEventListener(`click`,()=>{let e=So();tr({id:t.id,symbols:e.slice(0,n.slots)})}),e.querySelector(`#mc-favorites`)?.addEventListener(`click`,()=>{tr({id:t.id,symbols:jn().slice(0,n.slots)})}),e.querySelectorAll(`.mc-cell`).forEach(e=>{let n=e.querySelector(`.mc-chart`),i=e.dataset.symbol,a=r.get(i);n&&a?.candles&&Jr(n,a.candles,{height:140}),e.querySelector(`.mc-sym-select`)?.addEventListener(`change`,n=>{let r=Number(e.dataset.idx),i=[...t.symbols];for(;i.length<=r;)i.push(bo[i.length%bo.length]);i[r]=n.target.value,tr({id:t.id,symbols:i})}),e.addEventListener(`click`,e=>{e.target.tagName!==`SELECT`&&window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:i}))})})}function So(){try{return JSON.parse(localStorage.getItem(`stockviz-settings`)||`{}`).watchlist||bo}catch{return bo}}function Co(e,t,n){let r=G(t?.changePct);return`
  ...
  `}function wo(e){let t=Wn(),n=t.filter(e=>e.active&&!e.triggered),r=t.filter(e=>e.triggered);e.innerHTML=`
    <div class="page-header">
      <h1>Custom Alerts</h1>
    ...
    <div class="two-col">
      <section class="panel">
        ...
        ${n.length?To(n,!1):`<p class="muted">No active alerts.</p>`}
      </section>
      <section class="panel">
      ...
      <tbody>
        ${e.map(e=>`
          <tr>
            ...
            <td>${e.value}</td>
            <td>${t?`<span class="pos">${e.triggerDetail||`Triggered`}</span> <span class="muted">${Eo(e.triggeredAt)}</span>`:e.active?`Watching`:`Paused`}</td>
            <td>
  ...
  `}function Eo(e){return e?new Date(e).toLocaleString(`en-US`,{month:`short`,day:`numeric`,hour:`2-digit`,minute:`2-digit`}):``}function Do(e){let t=B(),n=va(t,bn()),r=[...t.values()],i=Ta(r.slice(0,2));e.innerHTML=`
    <div class="page-header">
      <h1>Export &amp; API</h1>
  ...
  `,e.querySelector(`#exp-csv`)?.addEventListener(`click`,()=>{Ca(n,`stockviz-screener.csv`,!1),H(`Exported ${n.length} rows`,`success`)}),e.querySelector(`#exp-csv-full`)?.addEventListener(`click`,()=>{Ca(r,`stockviz-full-ta.csv`,!0),H(`Exported ${r.length} rows with TA`,`success`)}),e.querySelector(`#exp-json`)?.addEventListener(`click`,()=>{wa(r),H(`Exported ${r.length} stocks as JSON`,`success`)}),e.querySelector(`#exp-clipboard`)?.addEventListener(`click`,async()=>{try{H(`Copied ${await Ea(r)} stocks to clipboard`,`success`)}catch{H(`Clipboard failed — use JSON download`,`error`)}}),e.querySelector(`#exp-sample`)?.addEventListener(`click`,()=>{wa(r.slice(0,5),`stockviz-api-sample.json`)})}function Oo(t){let n=new Map;for(let t of e)n.set(t,[]);for(let e of t.values())!e.sector||!n.has(e.sector)||n.get(e.sector).push(e);return e.map(e=>{let t=n.get(e)||[],r=t.length||1,i=t.reduce((e,t)=>e+(t.changePct||0),0)/r,a=t.filter(e=>e.changePct>0).length,o=t.filter(e=>e.prediction?.direction===`bullish`).length,s=t.reduce((e,t)=>e+(t.ta?.rsi??50),0)/r,c=t.reduce((e,t)=>e+(t.ta?.relVolume??1),0)/r,l=t.filter(e=>e.ta?.sma50&&e.price>e.ta.sma50).length,u=i*2+a/r*15+o/r*10+l/r*8,d=Math.max(0,Math.min(100,50+u));return{sector:e,count:t.length,avgChange:i,advancing:a,advancingPct:a/r*100,bullish:o,bullishPct:o/r*100,avgRsi:s,relVol:c,aboveSma50Pct:l/r*100,momentum:u,strength:d,topStock:t.sort((e,t)=>t.changePct-e.changePct)[0]||null,laggard:t.sort((e,t)=>e.changePct-t.changePct)[0]||null}}).sort((e,t)=>t.momentum-e.momentum)}function ko(e){return e.momentum>8?{label:`Leading`,color:`var(--green)`}:e.momentum>2?{label:`Improving`,color:`var(--accent)`}:e.momentum>-2?{label:`Neutral`,color:`var(--text-muted)`}:e.momentum>-8?{label:`Weakening`,color:`var(--yellow)`}:{label:`Lagging`,color:`var(--red)`}}async function Ao(e){let t=B(),n=z();jn();let r=Pn(),i=[...t.values()],a=dt(t),o=Oo(t).slice(0,5),[s,c]=await Promise.all([Br(n,t,6),qt(n).catch(()=>null)]),l=c?.earnings?.slice(0,4)||[],u=i.filter(e=>e.prediction?.direction===`bullish`).sort((e,t)=>(t.prediction?.confidence??0)-(e.prediction?.confidence??0)).slice(0,6);e.innerHTML=`
  ...
  `,e.querySelectorAll(`[data-symbol]`).forEach(e=>{e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})})}function jo(e){let t=B(),n=dt(t),r=jr(t),i=[...t.values()],a=i.filter(e=>(e.ta?.relVolume??1)>1.5).sort((e,t)=>(t.ta?.relVolume??1)-(e.ta?.relVolume??1)).slice(0,12),o=i.filter(e=>(e.ta?.rsi??50)<25||(e.ta?.rsi??50)>75).sort((e,t)=>Math.abs(50-(t.ta?.rsi??50))-Math.abs(50-(e.ta?.rsi??50))).slice(0,12),s=n.declining?n.advancing/n.declining:n.advancing;e.innerHTML=`
    <div class="page-header">
  ...
  `,e.querySelectorAll(`[data-symbol]`).forEach(e=>{e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})})}function Mo(e,t){let n=Math.min(e.length,t.length);if(n<3)return 0;let r=e.slice(-n),i=t.slice(-n),a=r.reduce((e,t)=>e+t,0)/n,o=i.reduce((e,t)=>e+t,0)/n,s=0,c=0,l=0;for(let e=0;e<n;e++){let t=r[e]-a,n=i[e]-o;s+=t*n,c+=t*t,l+=n*n}let u=Math.sqrt(c*l);return u?s/u:0}function No(e){if(!e?.length)return[];let t=e.map(e=>e.c),n=[];for(let e=1;e<t.length;e++)n.push((t[e]-t[e-1])/t[e-1]);return n}function Po(e,t,{period:n=30}={}){let r=new Map;for(let i of e){let e=t.get(i)?.candles;e?.length&&r.set(i,No(e).slice(-n))}let i=[...r.keys()];return{symbols:i,matrix:i.map(e=>i.map(t=>e===t?1:Mo(r.get(e),r.get(t))))}}function Fo(e){return e>=.7?`rgba(63,185,80,0.85)`:e>=.4?`rgba(63,185,80,0.45)`:e>=.15?`rgba(88,166,255,0.35)`:e>-.15?`rgba(139,148,158,0.25)`:e>-.4?`rgba(248,81,73,0.35)`:e>-.7?`rgba(248,81,73,0.55)`:`rgba(248,81,73,0.85)`}var Io={mag7:[`AAPL`,`MSFT`,`NVDA`,`GOOGL`,`AMZN`,`META`,`TSLA`],indices:[`SPY`,`QQQ`,`DIA`,`IWM`,`VTI`],semis:[`NVDA`,`AMD`,`INTC`,`AVGO`,`QCOM`,`MU`,`AMAT`],banks:[`JPM`,`BAC`,`WFC`,`GS`,`MS`,`C`]},$=`mag7`,Lo=``;function Ro(e){let t=B(),n=jn(),{symbols:r,matrix:i}=Po(zo($,Lo,n),t);e.innerHTML=`
          ...
          <tbody>
            ${i.map((e,t)=>`
              <tr>
                <th>${r[t]}</th>
                ${e.map((e,n)=>`
                  <td class="corr-cell" style="background:${Fo(e)}" title="${r[t]} vs ${r[n]}: ${e.toFixed(2)}">
                    ${t===n?`1.0`:e.toFixed(2)}
                  </td>
                `).join(``)}
              </tr>
    ...
    `}
  `,e.querySelector(`#corr-set`)?.addEventListener(`change`,t=>{$=t.target.value;let n=e.querySelector(`#corr-custom`);n&&(n.hidden=$!==`custom`),Ro(e)}),e.querySelector(`#corr-custom`)?.addEventListener(`change`,t=>{Lo=t.target.value,$=`custom`,Ro(e)})}function zo(e,t,n){return e===`custom`&&t?t.split(`,`).map(e=>e.trim().toUpperCase()).filter(Boolean).slice(0,12):e===`watchlist`?n.slice(0,12):Io[e]||Io.mag7}function Bo(e,t){let n=[];for(let r=0;r<e.length;r++)for(let i=r+1;i<e.length;i++)n.push({a:e[r],b:e[i],r:t[r][i]});return n.sort((e,t)=>Math.abs(e.r)-Math.abs(t.r)).slice(0,6)}var Vo={rsi_oversold:{label:`RSI Oversold Bounce`,desc:`Buy when RSI < 30, sell when RSI > 70`,entry:e=>e.rsi<30,exit:e=>e.rsi>70},rsi_overbought_short:{label:`RSI Overbought Fade`,desc:`Short when RSI > 70, cover when RSI < 40`,entry:e=>e.rsi>70,exit:e=>e.rsi<40,short:!0},sma_cross:{label:`SMA 20/50 Cross`,desc:`Buy golden cross, sell death cross`,entry:e=>e.sma20>e.sma50&&e.prevSma20<=e.prevSma50,exit:e=>e.sma20<e.sma50&&e.prevSma20>=e.prevSma50},momentum_breakout:{label:`5-Day Momentum`,desc:`Buy 3%+ 5-day move, exit on reversal`,entry:e=>e.mom5>3,exit:e=>e.mom5<0},macd_trend:{label:`MACD Histogram Trend`,desc:`Buy positive histogram, sell negative`,entry:e=>e.hist>0&&e.prevHist<=0,exit:e=>e.hist<0&&e.prevHist>=0}};function Ho(){return Object.entries(Vo).map(([e,t])=>({id:e,label:t.label,desc:t.desc}))}function Uo(e,t){let n=e.slice(0,t+1).map(e=>e.c),r=e.slice(0,t).map(e=>e.c),i=He(n),a=D(n,20),o=D(n,50),s=D(r,20),c=D(r,50),l=n.length>=6?(n[n.length-1]-n[n.length-6])/n[n.length-6]*100:0,u=Wo(n,12),d=Wo(n,26),f=(u??0)-(d??0),p=Wo(r,12),m=Wo(r,26),h=(p??0)-(m??0);return{price:n[n.length-1],rsi:i,sma20:a,sma50:o,prevSma20:s,prevSma50:c,mom5:l,hist:f,prevHist:h}}function Wo(e,t){if(e.length<t)return null;let n=2/(t+1),r=e.slice(0,t).reduce((e,t)=>e+t,0)/t;for(let i=t;i<e.length;i++)r=e[i]*n+r*(1-n);return r}function Go(e,t,{initialCapital:n=1e4}={}){let r=Vo[t];if(!r||!e?.length)return{trades:[],equity:[],stats:qo(n)};let i=[],a=[],o=n,s=0,c=0,l=0,u=r.short;for(let t=20;t<e.length;t++){let d=Uo(e,t),f=d.price;if(!s&&r.entry(d))s=o/f,c=f,l=t,o=0;else if(s&&r.exit(d)){let e=u?(c-f)*s:(f-c)*s,r=(f-c)/c*100*(u?-1:1);i.push({entryIdx:l,exitIdx:t,entryPrice:c,exitPrice:f,pl:e,plPct:r,days:t-l}),o=n+i.reduce((e,t)=>e+t.pl,0),s=0}let p=s?u?o+(c-f)*s:s*f:o;a.push({i:t,value:p,date:e[t].t})}if(s){let t=e[e.length-1].c,n=u?(c-t)*s:(t-c)*s;i.push({entryIdx:l,exitIdx:e.length-1,entryPrice:c,exitPrice:t,pl:n,plPct:(t-c)/c*100*(u?-1:1),days:e.length-1-l,open:!0})}return{trades:i,equity:a,stats:Ko(i,n,a.length?a[a.length-1].value:n,a),strategy:r.label}}function Ko(e,t,n,r){let i=e.filter(e=>!e.open),a=i.filter(e=>e.pl>0),o=n-t,s=o/t*100,c=t,l=0;for(let e of r){e.value>c&&(c=e.value);let t=(c-e.value)/c*100;t>l&&(l=t)}let u=r.slice(1).map((e,t)=>(e.value-r[t].value)/r[t].value),d=u.length?u.reduce((e,t)=>e+t,0)/u.length:0,f=u.length>1?Math.sqrt(u.reduce((e,t)=>e+(t-d)**2,0)/u.length):0,p=f?d/f*Math.sqrt(252):0;return{totalReturn:s,totalPl:o,finalValue:n,tradeCount:i.length,winRate:i.length?a.length/i.length*100:0,avgWin:a.length?a.reduce((e,t)=>e+t.plPct,0)/a.length:0,avgLoss:i.filter(e=>e.pl<=0).length?i.filter(e=>e.pl<=0).reduce((e,t)=>e+t.plPct,0)/i.filter(e=>e.pl<=0).length:0,maxDrawdown:l,sharpe:p,profitFactor:i.filter(e=>e.pl<0).length?Math.abs(a.reduce((e,t)=>e+t.pl,0)/i.filter(e=>e.pl<0).reduce((e,t)=>e+t.pl,0)):a.length?999:0}}function qo(e){return{totalReturn:0,totalPl:0,finalValue:e,tradeCount:0,winRate:0,avgWin:0,avgLoss:0,maxDrawdown:0,sharpe:0,profitFactor:0}}function Jo(e,{simulations:t=500,days:n=20}={}){if(!e?.length)return null;let r=e.map(e=>e.c),i=[];for(let e=1;e<r.length;e++)i.push((r[e]-r[e-1])/r[e-1]);let a=i.reduce((e,t)=>e+t,0)/i.length,o=Math.sqrt(i.reduce((e,t)=>e+(t-a)**2,0)/i.length),s=r[r.length-1],c=[];for(let e=0;e<t;e++){let e=s,t=[e];for(let r=0;r<n;r++){let n=Yo();e=Math.max(1,e*(1+a+o*n)),t.push(e)}c.push(t)}let l=c.map(e=>e[e.length-1]).sort((e,t)=>e-t),u=e=>l[Math.floor(t*e)];return{start:s,days:n,simulations:t,median:u(.5),p10:u(.1),p90:u(.9),bullishPct:l.filter(e=>e>s).length/t*100,paths:c.slice(0,50)}}function Yo(){let e=1-Math.random(),t=Math.random();return Math.sqrt(-2*Math.log(e))*Math.cos(2*Math.PI*t)}var Xo=`AAPL`,Zo=`rsi_oversold`,Qo=[];async function $o(e){let t=B(),n=z(),r=t.get(Xo),i=Ho(),a=A(n)!==`mock`;e.innerHTML=`<div class="page-header"><h1>Strategy Backtester</h1><p class="page-sub">Loading historical data…</p></div>`,Qo=await Ut(Xo,n,`D`,120);let o=Qo.length?Qo:r?.candles||[],s=Go(o,Zo),c=Jo(o);e.innerHTML=`
    <div class="page-header backtest-header">
      ...
      <div class="backtest-controls">
        <select id="bt-symbol" class="chart-select">
          ${E().slice(0,80).map(e=>`<option value="${e.symbol}" ${e.symbol===Xo?`selected`:``}>${e.symbol}</option>`).join(``)}
        </select>
        <select id="bt-strategy" class="chart-select">
          ${i.map(e=>`<option value="${e.id}" ${e.id===Zo?`selected`:``}>${e.label}</option>`).join(``)}
        </select>
      </div>
    </div>

    ${r?`
      <p class="page-sub">${i.find(e=>e.id===Zo)?.desc}</p>
  ...
  `,s.equity?.length&&es(e.querySelector(`#equity-chart`),s.equity,1e4),c?.paths&&ts(e.querySelector(`#monte-chart`),c),e.querySelector(`#bt-symbol`)?.addEventListener(`change`,t=>{Xo=t.target.value,$o(e)}),e.querySelector(`#bt-strategy`)?.addEventListener(`change`,t=>{Zo=t.target.value,$o(e)})}function es(e,t,n){if(!e)return;let r=window.devicePixelRatio||1,i=e.parentElement?.clientWidth||400;e.width=i*r,e.style.width=`${i}px`,e.height=200*r;let a=e.getContext(`2d`);a.scale(r,r);let o=t.map(e=>e.value),s=Math.min(...o,n)*.98,c=Math.max(...o,n)*1.02-s||1;a.fillStyle=getComputedStyle(document.documentElement).getPropertyValue(`--bg-panel`).trim()||`#1c2128`,a.fillRect(0,0,i,200),a.strokeStyle=`rgba(139,148,158,0.3)`,a.beginPath(),a.moveTo(10,10+180*(1-(n-s)/c)),a.lineTo(i-10,10+180*(1-(n-s)/c)),a.stroke(),a.strokeStyle=`#58a6ff`,a.lineWidth=2,a.beginPath(),o.forEach((e,t)=>{let n=10+t/(o.length-1||1)*(i-20),r=10+180*(1-(e-s)/c);t===0?a.moveTo(n,r):a.lineTo(n,r)}),a.stroke()}function ts(e,t){if(!e)return;let n=window.devicePixelRatio||1,r=e.parentElement?.clientWidth||400;e.width=r*n,e.style.width=`${r}px`,e.height=200*n;let i=e.getContext(`2d`);i.scale(n,n);let a=t.paths.flat(),o=Math.min(...a)*.98,s=Math.max(...a)*1.02-o||1;t.paths.forEach((e,t)=>{i.strokeStyle=`rgba(88,166,255,${.15+t%3*.05})`,i.lineWidth=1,i.beginPath(),e.forEach((t,n)=>{let a=10+n/(e.length-1)*(r-20),c=10+180*(1-(t-o)/s);n===0?i.moveTo(a,c):i.lineTo(a,c)}),i.stroke()}),i.strokeStyle=`#3fb950`,i.lineWidth=2;let c=t.paths[0];c&&(i.beginPath(),c.forEach((e,n)=>{let a=10+n/(c.length-1)*(r-20),l=10+180*(1-(t.median-o)/s);n===0?i.moveTo(a,l):i.lineTo(a,(t.median,l))}))}var ns=`all`;async function rs(e){let t=B(),n=await Br(z(),t,60),r=n.some(e=>e.live);ns===`unusual`?n=n.filter(e=>e.unusual):ns===`bullish`?n=n.filter(e=>e.sentiment===`bullish`):ns===`bearish`&&(n=n.filter(e=>e.sentiment===`bearish`));let i=n.reduce((e,t)=>e+t.notional,0),a=n.filter(e=>e.sentiment===`bullish`).length;e.innerHTML=`
    <div class="page-header">
      <h1>Options Flow</h1>
    ...
    <div class="filter-chips">
      ${[`all`,`unusual`,`bullish`,`bearish`].map(e=>`
        <button class="preset-chip ${ns===e?`active`:``}" data-filter="${e}">${e.charAt(0).toUpperCase()+e.slice(1)}</button>
      `).join(``)}
    </div>
  ...
  `,e.querySelectorAll(`[data-filter]`).forEach(t=>{t.addEventListener(`click`,()=>{ns=t.dataset.filter,rs(e)})}),e.querySelectorAll(`[data-symbol]`).forEach(e=>{e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})})}var is=`upside`,as=`desc`;async function os(e){let t=B(),n=await Rr(z(),t),r=n.some(e=>e.live);n.sort((e,t)=>{let n=e[is]??0,r=t[is]??0;return as===`desc`?r-n:n-r});let i=n.filter(e=>e.revisions>0).length,a=n.filter(e=>e.revisions<0).length;e.innerHTML=`
    <div class="page-header">
  ...
  `,e.querySelectorAll(`[data-sort]`).forEach(t=>{t.addEventListener(`click`,()=>{let n=t.dataset.sort;is===n?as=as===`desc`?`asc`:`desc`:(is=n,as=`desc`),os(e)})}),e.querySelectorAll(`[data-symbol]`).forEach(e=>{e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})})}function ss(e){let t=Oo(B());e.innerHTML=`
    <div class="page-header">
  ...
  `,e.querySelectorAll(`[data-symbol]`).forEach(e=>{e.dataset.symbol&&e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})})}var cs=0;async function ls(e){let t=B(),n=await zr(z(),t),r=n.some(e=>e.live);cs>0&&(n=n.filter(e=>e.squeezeScore>=cs)),e.innerHTML=`
    <div class="page-header">
    ...
    <div class="filter-chips">
      <button class="preset-chip ${cs===0?`active`:``}" data-min="0">All</button>
      <button class="preset-chip ${cs===50?`active`:``}" data-min="50">Squeeze 50+</button>
      <button class="preset-chip ${cs===70?`active`:``}" data-min="70">Squeeze 70+</button>
      <button class="preset-chip ${cs===85?`active`:``}" data-min="85">High Risk 85+</button>
    </div>
  ...
  `,e.querySelectorAll(`[data-min]`).forEach(t=>{t.addEventListener(`click`,()=>{cs=Number(t.dataset.min),ls(e)})}),e.querySelectorAll(`[data-symbol]`).forEach(e=>{e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})})}function us(e){let t=jn(),n=B(),r=t.map(e=>({sym:e,q:n.get(e)})).filter(e=>e.q);e.innerHTML=`
    <div class="page-header">
      <h1>Watchlist</h1>
  ...
  `,e.querySelectorAll(`[data-symbol]`).forEach(e=>{e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.symbol}))})})}function fs(e){let t=Ln(),n=B(),r=t.map(e=>{let t=n.get(e.symbol)?.price??e.entryPrice,r=e.side===`long`?(t-e.entryPrice)*e.shares:(e.entryPrice-t)*e.shares,i=(t-e.entryPrice)/e.entryPrice*100*(e.side===`long`?1:-1);return{...e,current:t,pnl:r,pnlPct:i,open:!e.closedAt}}),i=r.filter(e=>e.open),a=r.filter(e=>!e.open),o=r.reduce((e,t)=>e+(t.closedAt?t.realizedPnl??t.pnl:t.pnl),0);e.innerHTML=`
    ...
    `:``}
  `,e.querySelector(`#paper-form`)?.addEventListener(`submit`,e=>{e.preventDefault();let t=new FormData(e.target),r=t.get(`symbol`).toString().toUpperCase(),i=n.get(r);Rn({symbol:r,side:t.get(`side`),shares:Number(t.get(`shares`)),entryPrice:i?.price??100})}),e.querySelectorAll(`[data-close]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=i.find(t=>t.id===e.dataset.close);t&&zn(t.id,t.current)})}),e.querySelectorAll(`[data-rm]`).forEach(e=>{e.addEventListener(`click`,()=>Bn(e.dataset.rm))})}var ps={h:{path:`/`,label:`Home`},d:{path:`/dashboard`,label:`Dashboard`},s:{path:`/screener`,label:`Screener`},w:{path:`/watchlist`,label:`Watchlist`},n:{path:`/news`,label:`News`},p:{path:`/portfolio`,label:`Portfolio`},a:{path:`/alerts`,label:`Alerts`},g:{path:`/groups`,label:`Groups`},c:{path:`/charts`,label:`Charts`},",":{path:`/settings`,label:`Settings`}};function ms(){document.addEventListener(`keydown`,e=>{if(e.target.matches(`input, textarea, select`)||e.ctrlKey||e.metaKey||e.altKey)return;if(e.key===`?`){hs();return}let t=ps[e.key];t&&(e.preventDefault(),location.hash=t.path)})}function hs(){let e=document.getElementById(`kbd-help`);if(e){e.remove();return}let t=document.createElement(`div`);t.id=`kbd-help`,t.className=`kbd-help-overlay`,t.innerHTML=`
    <div class="kbd-help panel">
      <h3>Keyboard Shortcuts</h3>
      <ul>
        <li><kbd>/</kbd> or <kbd>Ctrl+K</kbd> — Search ticker</li>
        ${Object.entries(ps).map(([e,t])=>`<li><kbd>${e}</kbd> — ${t.label}</li>`).join(``)}
        <li><kbd>?</kbd> — Toggle this help</li>
        <li><kbd>Esc</kbd> — Close panels</li>
      </ul>
      <button class="btn-secondary" id="kbd-close">Close</button>
    </div>
  `,document.body.appendChild(t),t.addEventListener(`click`,e=>{e.target===t&&t.remove()}),t.querySelector(`#kbd-close`)?.addEventListener(`click`,()=>t.remove())}async function gs(e,t){let n=e.alertWebhookUrl?.trim();if(!n)return!1;try{return(await fetch(n,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({text:`StockViz Alert: ${t.symbol} — ${t.detail}`,symbol:t.symbol,type:t.type,value:t.value,detail:t.detail,triggeredAt:Date.now()})})).ok}catch{return!1}}var _s={"/":Yi,"/dashboard":Ao,"/screener":La,"/map":Va,"/news":Ha,"/portfolio":Wa,"/compare":qa,"/signals":Ya,"/patterns":Xa,"/groups":Za,"/charts":$a,"/multicharts":xo,"/alerts":wo,"/export":Do,"/internals":jo,"/correlation":Ro,"/backtest":$o,"/options":rs,"/analyst":os,"/rotation":ss,"/shorts":ls,"/futures":to,"/calendar":no,"/insider":ro,"/settings":go,"/watchlist":us,"/dividends":ds,"/paper":fs},vs=new Set([`quotes`,`status`]),ys=`/`,bs=!0;async function xs(){let e=z();try{let[{quotes:t,source:n},r]=await Promise.all([zt(e),Kt(e)]);En(t,{fetchedAt:Date.now(),source:n}),Dn(r),Ss(n),ur(t).forEach(t=>{H(`Alert: ${t.symbol} — ${t.detail}`,`success`,5e3),e.pushNotifications&&so({title:`StockViz: ${t.symbol}`,body:t.detail,tag:`alert-${t.id}`}),gs(e,t)}),Cs()}catch(e){console.error(`Quote fetch failed:`,e),Ss(`error`)}}function Ss(e){let t=document.getElementById(`status-dot`),n=document.getElementById(`status-text`),r=document.getElementById(`last-update`),i=document.getElementById(`market-status`),a=kn(),o=On();if(e===`error`)t.className=`status-dot`,n.textContent=`Update failed`;else if(e===`fmp`){t.className=`status-dot live`;let e=je();n.textContent=e.source===`sp500`?`Live · FMP · ${e.label}`:`Live · FMP`}else e===`finnhub`?(t.className=`status-dot live`,n.textContent=`Live · Finnhub`):(t.className=`status-dot mock`,n.textContent=`Simulated + TA Engine`);a.lastFetchAt&&(r.textContent=`Updated ${_r(a.lastFetchAt)}`),i&&o&&(i.textContent=o.label,i.className=`market-status ${o.isOpen?`open`:`closed`}`),ws()}function Cs(){let e=document.getElementById(`alert-badge`);if(!e)return;let t=Gn(),n=Kn();e.textContent=t+n,e.hidden=t+n===0,e.classList.toggle(`has-triggered`,n>0)}function ws(){let e=document.getElementById(`footer-stats`);if(!e)return;let t=[...B().values()],n=t.reduce((e,t)=>e+(t.patterns?.length||0),0),r=t.filter(e=>e.prediction?.direction===`bullish`).length;e.innerHTML=`
    <span>${je().label}</span>
    <span>${n} patterns</span>
    <span class="pos">${r} bullish</span>
  `}var Ts=null;async function Es(){let e=await Gr(z()).catch(()=>null);e?.size&&(Ts=e)}function Ds(){let e=document.getElementById(`ticker-bar`),t=B(),n=[`SPY`,`QQQ`,`DIA`,`IWM`],r={SPY:`S&P 500`,QQQ:`NASDAQ`,DIA:`DOW`,IWM:`RUSSELL 2K`};e.innerHTML=n.map(e=>{let n=Ts?.get(e),i=n||t.get(e);if(!i)return``;let a=G(i.changePct),o=i.price,s=i.changePct;return`
    ...
    `}).join(``),e.querySelectorAll(`.ticker-item`).forEach(e=>{e.style.cursor=`pointer`,e.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`stockviz:select`,{detail:e.dataset.liveSymbol}))})})}function Os(){document.querySelectorAll(`canvas[data-spark]`).forEach(e=>{let t=B().get(e.dataset.spark);t?.sparkline?.length&&yr(e,t.sparkline,{width:Number(e.getAttribute(`width`))||72,height:Number(e.getAttribute(`height`))||24})})}function ks(){return(location.hash.slice(1)||`/`).split(`?`)[0]||`/`}function As(e=!0){ys=ks(),_s[ys]||(ys=`/`),document.querySelectorAll(`.main-nav a`).forEach(e=>{e.classList.toggle(`active`,e.getAttribute(`href`)?.startsWith(`#${ys}`))});let t=document.getElementById(`main-content`);e&&!bs&&t.classList.add(`page-enter`);let n=(_s[ys]||Yi)(t),r=()=>{Ds(),Os(),e&&requestAnimationFrame(()=>t.classList.remove(`page-enter`)),bs=!1};n?.then?n.then(r):r(),document.getElementById(`nav-toggle`)?.setAttribute(`aria-expanded`,`false`),document.querySelector(`.main-nav`)?.classList.remove(`open`)}function js(e){if(e===`alerts`&&Cs(),vs.has(e)&&_s[ys]){Sr(),Ds(),Ss(kn().dataSource);return}_s[ys]?As(!1):Ds()}function Ms(){ci(),_i(),pr(),ms(),Es(),document.getElementById(`nav-toggle`)?.addEventListener(`click`,()=>{document.querySelector(`.main-nav`)?.classList.toggle(`open`)}),document.getElementById(`theme-toggle`)?.addEventListener(`click`,yn),_n(z().theme),ja(),window.addEventListener(`hashchange`,()=>{ja(),As()}),window.addEventListener(`stockviz:select`,e=>{An(e.detail),li(e.detail)}),window.addEventListener(`stockviz:settings-saved`,async()=>{cr(),Ts=null,await ze(z()),Es(),xs().then(()=>sr(xs))}),or(js),ze(z()).then(()=>{xs().then(()=>{As(),sr(xs)})}),`serviceWorker`in navigator&&navigator.serviceWorker.register(`/stockviz/sw.js`).catch(()=>{})}Ms();